...
public class DhmsQuebecImplementation implements DhmsQuebec {
    ...
    public String add_appointment(String appointment_id, String type, String capacity) {
        ...
        if(flag.equals(1)){
            ...
            try {
                File log_file = new File("D:\\web_services\\quebec_server\\logs\\admin_log.txt");
                if (log_file.createNewFile()) {
                    FileWriter log_file_writer = new FileWriter("D:\\web_services\\quebec_server\\logs\\admin_log.txt");
                    ...
                    BufferedWriter log_file_buffered_writer = new BufferedWriter(new FileWriter("D:\\web_services\\quebec_server\\logs\\admin_log.txt", true));
    ...
    public String book_appointment(String patient_id, String appointment_id, String type) {
        ...
        if(count >= 3){
            ...
            if(flag.equals(1)){
                ...
                //creating log file and keeping records
                try {
                    File log_file = new File("D:\\web_services\\quebec_server\\logs\\"+ patient_id +".txt");
                    if (log_file.createNewFile()) {
                        //client file writer
                        FileWriter log_file_writer = new FileWriter("D:\\web_services\\quebec_server\\logs\\"+ patient_id +".txt");
                        ...
                        log_file_writer.close();
                        //admin file writer
                        FileWriter admin_log_file_writer = new FileWriter("D:\\web_services\\quebec_server\\logs\\admin_log.txt");
                        ...
                        //client file writer
                        BufferedWriter log_file_buffered_writer = new BufferedWriter(new FileWriter("D:\\web_services\\quebec_server\\logs\\"+ patient_id +".txt", true));
                        ...
                        log_file_buffered_writer.close();
                        //admin file writer
                        BufferedWriter admin_log_file_buffered_writer = new BufferedWriter(new FileWriter("D:\\web_services\\quebec_server\\logs\\admin_log.txt", true));
    ...
    public String[] get_appointment_records(String appointment_type) {
        ...
        String records_sherbrooke_string = sc.request_appointment_records_sherbrooke(appointment_type);
        String[] records_sherbrooke = records_sherbrooke_string.split(";");
        
        database db = new database();
    	int array_size = db.appointments.get(appointment_type).values().size() + records_montreal.length + records_sherbrooke.length;
        ...
        for(String record : records_sherbrooke){
        	records[i] = record;
        	i++;
        }
